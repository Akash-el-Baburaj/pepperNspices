...
@Component({
  ...
  template: `
    <footer class="bg-moss-950 text-gray-300 pt-16 pb-8 border-t border-moss-900">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-3 pt-3">
              <!-- Social Icons -->
              <a href="#" class="p-2 bg-white/5 hover:bg-moss-500 hover:text-white rounded-lg transition-colors duration-200">
          ...
          <div class="space-y-4">
            ...
            @if (newsletterSubmitted()) {
              <div class="p-3 bg-moss-900/30 rounded-xl border border-moss-800 text-center text-xs text-saffron-400 font-bold animate-fade-in">
              ...
              <form (submit)="onSubscribe($event)" class="flex gap-2">
                <input 
                  ...
                  required
                  class="flex-grow px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-xs text-white placeholder-gray-500 focus:outline-none focus:border-saffron-500 transition-colors duration-200"
                />
                <button 
                  type="submit" 
                  class="px-4 py-2 bg-moss-600 hover:bg-moss-500 text-white text-xs font-bold rounded-xl transition-all duration-200 hover:scale-105 active:scale-95"
                >
                  Join
                </button>
              </form>
        ...
        <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <p>© 2026 Sasya Organic Botanicals. Crafted for culinary artisans.</p>
